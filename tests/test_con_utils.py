...
class TestConUtils(unittest.TestCase):
    error_mapping = {
        ...
        "invalid_credentials_file": (RuntimeError, "cannot read credentials"),
        ...
        "invalid_tls_security": (
            ValueError,
            "tls_security can only be one of `insecure`, "
    ...
    def run_testcase(self, testcase):
        ...
        test_env = {
            ...
            "EDGEDB_PORT": None,
            "EDGEDB_USER": None,
            "EDGEDB_PASSWORD": None,
            "EDGEDB_SECRET_KEY": None,
            "EDGEDB_DATABASE": None,
            "PGSSLMODE": None,
        ...
        with contextlib.ExitStack() as es:
            ...
            result = {
                "address": [
                    connect_config.address[0],
                    connect_config.address[1],
                ],
    ...
    def test_test_connect_params_environ(self):
        ...
        try:
            ...
            with self.environ(
                AAAAAAAAAA123="1", AAAAAAAAAA456="2", AAAAAAAAAA789=None
            ):
    ...
    def test_connect_params(self):
        ...
        for i, testcase in enumerate(testcases):
            with self.subTest(i=i):
                wait_until_available = testcase.get("result", {}).get(
                    "waitUntilAvailable"
                )
    ...
    def test_stash_path(self):
        self.assertEqual(
            ...
            pathlib.Path(
                "/home/user/.config/edgedb/projects/project1-"
    ...
    def test_project_config(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch(
                "edgedb.platform.config_dir", lambda: home / ".edgedb"
    ...
    def test_validate_wait_until_available(self):
        ...
        for string, expected in valid:
            with self.subTest(duration=string):
                self.assertEqual(
                    expected, con_utils._validate_wait_until_available(string)
                )
